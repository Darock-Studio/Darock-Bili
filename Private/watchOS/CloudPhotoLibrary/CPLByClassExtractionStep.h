...
/* instance methods */
- (id)initWithStorage:(id)storage scopeIdentifier:(id)identifier description:(id)description class:(Class)class maximumCount:(unsigned long long)count query:(undefined *)query;
