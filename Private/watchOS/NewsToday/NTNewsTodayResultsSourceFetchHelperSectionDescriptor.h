...
@property (readonly, copy, nonatomic) NSObject<NTSectionDescriptor> *sectionDescriptor;
@property (readonly, copy, nonatomic) NSObject<NTSectionQueueDescriptor> *parentSectionQueueDescriptor;
