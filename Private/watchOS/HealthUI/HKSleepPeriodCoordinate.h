...
/* instance methods */
- (id)initWithXValue:(double)xvalue asleepYValues:(id)yvalues inBedYValues:(id)yvalues yValues:(id)values upperGoalYValue:(id)yvalue lowerGoalYValue:(id)yvalue highlighted:(BOOL)highlighted userInfo:(id)info;
