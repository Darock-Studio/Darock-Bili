...
@interface CLPCellTowerLocation : PBCodable<NSCopying> {
  /* instance variables */
  struct { unsigned int x :1 arfcn; unsigned int x :1 ecn0; unsigned int x :1 psc; unsigned int x :1 rat; unsigned int x :1 rscp; unsigned int x :1 serverHash; unsigned int x :1 transmit; unsigned int x :1 hasWifiFallback; unsigned int x :1 isLimitedService; unsigned int x :1 uniqueCount; } _has;
}
