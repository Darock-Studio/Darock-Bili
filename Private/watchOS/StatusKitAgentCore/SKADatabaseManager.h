...
@property (readonly, nonatomic) NSObject<SKADatabaseProviding> *databaseProvider;
@property (readonly, weak, nonatomic) NSObject<SKADatabaseManagingDelegate> *delegate;
...
- (id)_existingDecomissionedPersonalChannelsWithDatabaseContext:(id)context;
...
- (id)_existingTransientSubscriptionHistoryWithLimit:(long long)limit orderedByLastSubscriptionDateAscending:(BOOL)ascending databaseContext:(id)context;
