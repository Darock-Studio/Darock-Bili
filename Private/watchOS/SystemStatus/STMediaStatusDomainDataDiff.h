...
/* instance methods */
- (id)init;
- (id)initWithMicrophoneRecordingAttributionListDataDiff:(id)diff mutedMicrophoneRecordingAttributionListDataDiff:(id)diff systemAudioRecordingAttributionListDataDiff:(id)diff cameraAttributionListDataDiff:(id)diff;
