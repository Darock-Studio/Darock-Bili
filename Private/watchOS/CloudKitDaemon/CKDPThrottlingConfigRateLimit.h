...
@interface CKDPThrottlingConfigRateLimit : PBCodable<NSCopying> {
  /* instance variables */
  struct { unsigned int x :1 startTimeSecondsAfterLocalMidnight; unsigned int x :1 startTimeSecondsAfterUnixEpoch; unsigned int x :1 allowedRequestCount; unsigned int x :1 intervalLengthSec; unsigned int x :1 repeatEverySec; } _has;
}
