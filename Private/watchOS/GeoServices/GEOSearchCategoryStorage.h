...
@interface GEOSearchCategoryStorage : PBCodable<NSCopying> {
  ...
  struct { unsigned int x :1 read_unknownFields; unsigned int x :1 read_autocompleteEntry; unsigned int x :1 read_browseCategory; unsigned int x :1 wrote_anyField; } _flags;
}
