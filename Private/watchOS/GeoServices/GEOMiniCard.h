...
@interface GEOMiniCard : PBCodable<NSCopying> {
  ...
  struct { unsigned int x :1 has_shouldEmphasize; unsigned int x :1 read_unknownFields; unsigned int x :1 read_buttonText; unsigned int x :1 read_detail; unsigned int x :1 read_metadata; unsigned int x :1 read_title; unsigned int x :1 wrote_anyField; } _flags;
}
