...
@interface GEOLogMsgStateDeviceLocale : PBCodable<NSCopying> {
  ...
  struct { unsigned int x :1 read_deviceInputLocale; unsigned int x :1 read_deviceOutputLocale; unsigned int x :1 read_deviceSettingsLocale; unsigned int x :1 wrote_anyField; } _flags;
}
