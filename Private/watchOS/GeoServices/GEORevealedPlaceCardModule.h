...
@interface GEORevealedPlaceCardModule : PBCodable<NSCopying> {
  ...
  struct { unsigned int x :1 has_type; unsigned int x :1 read_hours; unsigned int x :1 read_infos; unsigned int x :1 read_photos; unsigned int x :1 read_showcase; unsigned int x :1 read_title; unsigned int x :1 read_unifiedActionRow; unsigned int x :1 wrote_anyField; } _flags;
}
