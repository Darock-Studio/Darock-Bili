...
@interface GEOPBTransitPaymentMethodSuggestionDetails : PBCodable<NSCopying> {
  ...
  struct { unsigned int x :1 has_paymentMethodRegionMuid; unsigned int x :1 read_unknownFields; unsigned int x :1 read_educationalScreenAssets; unsigned int x :1 read_educationalScreenHeader; unsigned int x :1 read_educationalScreenPaymentBodys; unsigned int x :1 read_suggestionBody; unsigned int x :1 read_suggestionTitle; unsigned int x :1 wrote_anyField; } _flags;
}
