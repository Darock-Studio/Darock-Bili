...
@interface GEOMapsServerMetadata : PBCodable<NSCopying> {
  ...
  struct { unsigned int x :1 read_mapsSearchResults; unsigned int x :1 read_suggestionEntryMetadataDisplayeds; unsigned int x :1 read_suggestionEntryMetadataTappedOn; unsigned int x :1 wrote_anyField; } _flags;
}
