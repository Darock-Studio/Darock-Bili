...
@interface GEOLogMsgStateExperiments : PBCodable<NSCopying> {
  ...
  struct { unsigned int x :1 read_abAssignInfo; unsigned int x :1 read_clientAbExperimentAssignment; unsigned int x :1 read_datasetAbStatus; unsigned int x :1 read_tilesAbExperimentAssignment; unsigned int x :1 wrote_anyField; } _flags;
}
