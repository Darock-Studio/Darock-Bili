...
@interface GEOActionButtonDetail : PBCodable<NSCopying> {
  ...
  struct { unsigned int x :1 has_linkType; unsigned int x :1 has_dropDown; unsigned int x :1 read_category; unsigned int x :1 read_providerId; unsigned int x :1 wrote_anyField; } _flags;
}
