...
@interface GEOLogMsgEventEVRoutingVehicleDetails : PBCodable<NSCopying> {
  ...
  struct { unsigned int x :1 has_batteryCapacity; unsigned int x :1 has_towingNotSupported; unsigned int x :1 read_make; unsigned int x :1 read_model; unsigned int x :1 wrote_anyField; } _flags;
}
