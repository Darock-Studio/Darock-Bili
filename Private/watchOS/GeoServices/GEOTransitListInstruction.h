...
@interface GEOTransitListInstruction : PBCodable<GEOComposedRouteStepTransitInstructionMerging, NSCopying> {
  ...
  struct { unsigned int x :1 read_unknownFields; unsigned int x :1 read_commandFormatteds; unsigned int x :1 read_detailFormatteds; unsigned int x :1 read_expandableListFormatted; unsigned int x :1 read_noticeFormatteds; unsigned int x :1 read_priceFormatteds; unsigned int x :1 read_timeInstructions; unsigned int x :1 wrote_anyField; } _flags;
}
