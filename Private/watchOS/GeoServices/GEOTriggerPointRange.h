...
@interface GEOTriggerPointRange : PBCodable<NSCopying> {
  ...
  struct { unsigned int x :1 has_displayTime; unsigned int x :1 read_unknownFields; unsigned int x :1 read_hideAtPoint; unsigned int x :1 read_showAtPoint; unsigned int x :1 wrote_anyField; } _flags;
}
