...
@interface GEORPPhotoAttributionPreferences : PBCodable<NSCopying> {
  ...
  struct { unsigned int x :1 has_attributePhotos; unsigned int x :1 has_wasCleared; unsigned int x :1 read_attributionName; unsigned int x :1 read_version; unsigned int x :1 wrote_anyField; } _flags;
}
