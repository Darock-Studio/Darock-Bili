...
@interface GEOWaypointNameProperties : PBCodable<NSCopying> {
  /* instance variables */
  struct { unsigned int x :1 has_hasDisplayAddress; unsigned int x :1 has_hasDisplayName; unsigned int x :1 has_hasSpokenAddress; unsigned int x :1 has_hasSpokenName; } _flags;
}
