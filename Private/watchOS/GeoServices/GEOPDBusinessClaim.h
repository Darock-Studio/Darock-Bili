...
@interface GEOPDBusinessClaim : PBCodable<NSCopying> {
  ...
  struct { unsigned int x :1 has_buttonEnabled; unsigned int x :1 read_unknownFields; unsigned int x :1 read_buttonLabel; unsigned int x :1 read_descriptionText; unsigned int x :1 read_titleText; unsigned int x :1 wrote_anyField; } _flags;
}
