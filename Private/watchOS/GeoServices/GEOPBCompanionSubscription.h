...
@interface GEOPBCompanionSubscription : PBCodable<NSCopying> {
  ...
  struct { unsigned int x :1 has_dataType; unsigned int x :1 has_policy; unsigned int x :1 read_unknownFields; unsigned int x :1 read_identifier; unsigned int x :1 read_region; unsigned int x :1 wrote_anyField; } _flags;
}
