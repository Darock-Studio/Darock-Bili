...
@interface GEOSharedNavSenderInfo : PBCodable<NSCopying> {
  ...
  struct { unsigned int x :1 read_unknownFields; unsigned int x :1 read_fromDisplayName; unsigned int x :1 read_fromIdentifier; unsigned int x :1 read_localContactIdentifier; unsigned int x :1 read_localName; unsigned int x :1 wrote_anyField; } _flags;
}
