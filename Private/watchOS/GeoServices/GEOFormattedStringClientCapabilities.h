...
@interface GEOFormattedStringClientCapabilities : PBCodable<NSCopying> {
  /* instance variables */
  struct { unsigned int x :1 has_concatenatingFormatStringsSupported; unsigned int x :1 has_styleSupported; unsigned int x :1 has_timestampFormatPatternSupported; } _flags;
}
