...
@interface GEOPrivacyMetadata : PBCodable<NSCopying> {
  /* instance variables */
  struct { unsigned int x :1 has_isManagedAccount; unsigned int x :1 has_isMismatchedStorefrontDeviceRegion; unsigned int x :1 has_isSharedIpadForEducation; unsigned int x :1 has_isUnderageAccount; } _flags;
}
