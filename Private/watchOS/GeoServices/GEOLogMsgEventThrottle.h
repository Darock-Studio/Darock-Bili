...
@interface GEOLogMsgEventThrottle : PBCodable<NSCopying> {
  ...
  struct { unsigned int x :1 has_throttleDuration; unsigned int x :1 has_networkService; unsigned int x :1 has_throttleCount; unsigned int x :1 has_throttleMode; unsigned int x :1 has_throttleTriggerCount; unsigned int x :1 has_throttleTriggerDuration; unsigned int x :1 has_throttleType; unsigned int x :1 has_tilesetId; unsigned int x :1 read_manifestEnv; unsigned int x :1 read_requestAppIdentifier; unsigned int x :1 read_throttleReqType; unsigned int x :1 wrote_anyField; } _flags;
}
