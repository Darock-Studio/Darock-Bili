...
@interface GEOPBTransitStop : PBCodable<GEOTransitNamedItem, NSCopying> {
  ...
  struct { unsigned int x :1 has_muid; unsigned int x :1 has_hallIndex; unsigned int x :1 has_stopIndex; unsigned int x :1 read_unknownFields; unsigned int x :1 read_latLng; unsigned int x :1 read_nameDisplayString; unsigned int x :1 read_styleAttributes; unsigned int x :1 read_timezone; unsigned int x :1 read_zoomNames; unsigned int x :1 wrote_anyField; } _flags;
}
