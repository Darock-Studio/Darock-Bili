...
@interface GEOPDGroupData : PBCodable<NSCopying> {
  ...
  struct { unsigned int x :1 read_unknownFields; unsigned int x :1 read_buttonItems; unsigned int x :1 read_symbolImageName; unsigned int x :1 read_titles; unsigned int x :1 wrote_anyField; } _flags;
}
