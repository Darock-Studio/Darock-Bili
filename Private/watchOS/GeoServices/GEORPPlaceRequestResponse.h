...
@interface GEORPPlaceRequestResponse : PBCodable<NSCopying> {
  ...
  struct { unsigned int x :1 read_unknownFields; unsigned int x :1 read_placeRequest; unsigned int x :1 read_placeResponse; unsigned int x :1 wrote_anyField; } _flags;
}
