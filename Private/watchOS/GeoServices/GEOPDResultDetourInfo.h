...
@interface GEOPDResultDetourInfo : PBCodable<NSCopying> {
  /* instance variables */
  struct { unsigned int x :1 has_detourDistance; unsigned int x :1 has_detourTime; unsigned int x :1 has_distanceToPlace; unsigned int x :1 has_timeToPlace; } _flags;
}
