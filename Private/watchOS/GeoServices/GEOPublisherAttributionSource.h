...
@interface GEOPublisherAttributionSource : PBCodable<NSCopying> {
  ...
  struct { unsigned int x :1 read_appAdamID; unsigned int x :1 read_localizedAttributions; unsigned int x :1 read_websiteURL; unsigned int x :1 wrote_anyField; } _flags;
}
