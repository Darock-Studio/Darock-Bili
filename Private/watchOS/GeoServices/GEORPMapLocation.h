...
@interface GEORPMapLocation : PBCodable<NSCopying> {
  ...
  struct { unsigned int x :1 has_zoomLevel; unsigned int x :1 read_coordinate; unsigned int x :1 read_image; unsigned int x :1 read_mapScreenshotId; unsigned int x :1 read_viewportInfo; unsigned int x :1 wrote_anyField; } _flags;
}
