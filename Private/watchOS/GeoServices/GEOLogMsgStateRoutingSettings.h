...
@interface GEOLogMsgStateRoutingSettings : PBCodable<NSCopying> {
  ...
  struct { unsigned int x :1 read_cyclingPrefs; unsigned int x :1 read_drivingPrefs; unsigned int x :1 read_virtualGarageSettings; unsigned int x :1 wrote_anyField; } _flags;
}
