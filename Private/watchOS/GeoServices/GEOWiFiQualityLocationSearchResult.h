...
@interface GEOWiFiQualityLocationSearchResult : PBCodable<NSCopying> {
  ...
  struct { unsigned int x :1 has_tileKey; unsigned int x :1 has_status; unsigned int x :1 read_ess; unsigned int x :1 read_location; unsigned int x :1 read_tiles; unsigned int x :1 wrote_anyField; } _flags;
}
