...
@interface GEOTransitRouteIdentifier : PBCodable<NSCopying> {
  ...
  struct { unsigned int x :1 read_unknownFields; unsigned int x :1 read_clientRouteHandle; unsigned int x :1 read_serverRouteHandle; unsigned int x :1 wrote_anyField; } _flags;
}
