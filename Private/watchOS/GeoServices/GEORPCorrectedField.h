...
@interface GEORPCorrectedField : PBCodable<NSCopying> {
  ...
  struct { unsigned int x :1 has_field; unsigned int x :1 has_isMarkedIncorrect; unsigned int x :1 read_correctedValue; unsigned int x :1 read_fieldName; unsigned int x :1 read_originalValue; unsigned int x :1 wrote_anyField; } _flags;
}
