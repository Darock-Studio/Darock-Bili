...
@interface GEOLaunchAndGoCardText : PBCodable<NSCopying> {
  ...
  struct { unsigned int x :1 read_unknownFields; unsigned int x :1 read_body; unsigned int x :1 read_cardTitle; unsigned int x :1 read_commuteTitle; unsigned int x :1 read_routeDescription; unsigned int x :1 read_routeTitle; unsigned int x :1 read_title; unsigned int x :1 wrote_anyField; } _flags;
}
