...
@interface GEORPSourceInfo : PBCodable<NSCopying> {
  ...
  struct { unsigned int x :1 read_unknownFields; unsigned int x :1 read_sourceApplication; unsigned int x :1 read_sourceUrl; unsigned int x :1 wrote_anyField; } _flags;
}
