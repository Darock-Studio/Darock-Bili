...
@interface GEORouteAnnotation : PBCodable<NSCopying> {
  ...
  struct { unsigned int x :1 has_deprecatedOffsetMeters; unsigned int x :1 has_offsetMeters; unsigned int x :1 read_unknownFields; unsigned int x :1 read_artwork; unsigned int x :1 read_infoCard; unsigned int x :1 wrote_anyField; } _flags;
}
