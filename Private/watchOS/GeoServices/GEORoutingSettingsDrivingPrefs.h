...
@interface GEORoutingSettingsDrivingPrefs : PBCodable<NSCopying> {
  /* instance variables */
  struct { unsigned int x :1 has_avoidHighways; unsigned int x :1 has_avoidTolls; unsigned int x :1 has_speedLimitEnabled; unsigned int x :1 has_trafficEnabled; unsigned int x :1 has_voiceNavEnabled; } _flags;
}
