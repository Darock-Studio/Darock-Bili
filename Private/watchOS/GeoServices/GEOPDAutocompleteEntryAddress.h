...
@interface GEOPDAutocompleteEntryAddress : PBCodable<NSCopying> {
  ...
  struct { unsigned int x :1 has_disambiguationRadiusMeters; unsigned int x :1 has_distance; unsigned int x :1 has_opaqueGeoId; unsigned int x :1 has_placeType; unsigned int x :1 has_shouldCallPlacesForClientization; unsigned int x :1 read_unknownFields; unsigned int x :1 read_center; unsigned int x :1 read_mapsId; unsigned int x :1 wrote_anyField; } _flags;
}
