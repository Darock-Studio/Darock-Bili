...
@interface GEOLogMsgStateMapUIShown : PBCodable<NSCopying> {
  /* instance variables */
  struct { unsigned int x :1 has_activeNavMode; unsigned int x :1 has_isAirQualityShown; unsigned int x :1 has_isVenueExperienceShown; unsigned int x :1 has_isWeatherShown; } _flags;
}
