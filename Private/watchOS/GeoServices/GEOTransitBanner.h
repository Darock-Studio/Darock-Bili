...
@interface GEOTransitBanner : PBCodable<NSCopying> {
  ...
  struct { unsigned int x :1 read_unknownFields; unsigned int x :1 read_artwork; unsigned int x :1 read_primaryText; unsigned int x :1 read_secondaryText; unsigned int x :1 wrote_anyField; } _flags;
}
