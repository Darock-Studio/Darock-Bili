...
@interface GEORPPlaceContainmentCorrections : PBCodable<NSCopying> {
  ...
  struct { unsigned int x :1 read_unknownFields; unsigned int x :1 read_childContainment; unsigned int x :1 read_parentContainment; unsigned int x :1 wrote_anyField; } _flags;
}
