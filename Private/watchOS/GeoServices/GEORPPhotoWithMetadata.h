...
@interface GEORPPhotoWithMetadata : PBCodable<NSCopying> {
  ...
  struct { unsigned int x :1 has_creationDate; unsigned int x :1 has_geotagHorizontalAccuracy; unsigned int x :1 has_geotagTimestamp; unsigned int x :1 read_imageData; unsigned int x :1 read_geotagCoordinate; unsigned int x :1 wrote_anyField; } _flags;
}
