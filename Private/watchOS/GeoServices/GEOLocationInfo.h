...
@interface GEOLocationInfo : PBCodable<NSCopying> {
  ...
  struct { unsigned int x :1 read_unknownFields; unsigned int x :1 read_localityName; unsigned int x :1 read_locationName; unsigned int x :1 read_secondaryLocationName; unsigned int x :1 wrote_anyField; } _flags;
}
