...
@interface GEOTrafficSignal : PBCodable<NSCopying> {
  ...
  struct { unsigned int x :1 has_countryCodeStyleId; unsigned int x :1 has_type; unsigned int x :1 read_unknownFields; unsigned int x :1 read_identifier; unsigned int x :1 read_position; unsigned int x :1 wrote_anyField; } _flags;
}
