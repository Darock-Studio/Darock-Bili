...
@interface GEOARSessionThermalPressure : PBCodable<NSCopying> {
  /* instance variables */
  struct { unsigned int x :1 has_timestamp; unsigned int x :1 has_chargingState; unsigned int x :1 has_collectionTrigger; unsigned int x :1 has_thermalPressure; } _flags;
}
