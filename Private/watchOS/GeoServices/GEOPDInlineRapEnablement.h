...
@interface GEOPDInlineRapEnablement : PBCodable<NSCopying> {
  /* instance variables */
  struct { unsigned int x :1 has_isAddressEditable; unsigned int x :1 has_isHoursEditable; unsigned int x :1 has_isPhoneEditable; unsigned int x :1 has_isWebsiteEditable; } _flags;
}
