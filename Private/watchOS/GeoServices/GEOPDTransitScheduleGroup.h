...
@interface GEOPDTransitScheduleGroup : PBCodable<NSCopying> {
  ...
  struct { unsigned int x :1 has_groupType; unsigned int x :1 has_maxWalkingDistance; unsigned int x :1 has_maxWalkingTime; unsigned int x :1 has_minWalkingDistance; unsigned int x :1 has_minWalkingTime; unsigned int x :1 read_unknownFields; unsigned int x :1 read_departureSequenceContainerIndexs; unsigned int x :1 read_departureSequenceIndexs; unsigned int x :1 read_incidentIds; unsigned int x :1 read_displayName; unsigned int x :1 read_pinnedDisplayName; unsigned int x :1 wrote_anyField; } _flags;
}
