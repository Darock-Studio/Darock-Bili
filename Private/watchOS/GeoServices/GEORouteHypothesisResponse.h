...
@interface GEORouteHypothesisResponse : PBCodable<NSCopying> {
  ...
  struct { unsigned int x :1 has_updatedTimeStamp; unsigned int x :1 read_directionsResponse; unsigned int x :1 read_etaResponse; unsigned int x :1 wrote_anyField; } _flags;
}
