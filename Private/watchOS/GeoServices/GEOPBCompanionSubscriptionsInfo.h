...
@interface GEOPBCompanionSubscriptionsInfo : PBCodable<NSCopying> {
  ...
  struct { unsigned int x :1 has_padding; unsigned int x :1 read_unknownFields; unsigned int x :1 read_loadedSubscriptions; unsigned int x :1 read_offlineTileMetadata; unsigned int x :1 wrote_anyField; } _flags;
}
