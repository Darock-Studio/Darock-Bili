...
@interface GEORPFeedbackImageUploadInfo : PBCodable<NSCopying> {
  ...
  struct { unsigned int x :1 read_unknownFields; unsigned int x :1 read_clientImageUuid; unsigned int x :1 read_imageId; unsigned int x :1 read_imageUploadHttpMethod; unsigned int x :1 read_imageUploadUrl; unsigned int x :1 wrote_anyField; } _flags;
}
