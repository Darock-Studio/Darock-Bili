...
@interface GEOPDSearchQueryGeoTagMetadata : PBCodable<NSCopying> {
  ...
  struct { unsigned int x :1 read_geoRewriteTypes; unsigned int x :1 read_tagSources; unsigned int x :1 read_geoParsingResult; unsigned int x :1 read_geoTypeMaps; unsigned int x :1 wrote_anyField; } _flags;
}
