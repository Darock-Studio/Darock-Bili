...
@interface GEOCyclingOptions : PBCodable<NSCopying> {
  ...
  struct { unsigned int x :1 read_unknownFields; unsigned int x :1 read_cyclingUserPreferences; unsigned int x :1 read_cyclingVehicleSpecifications; unsigned int x :1 wrote_anyField; } _flags;
}
