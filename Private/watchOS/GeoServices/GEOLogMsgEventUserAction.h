...
@interface GEOLogMsgEventUserAction : PBCodable<NSCopying> {
  ...
  struct { unsigned int x :1 has_buttonType; unsigned int x :1 has_userActionEventAction; unsigned int x :1 has_userActionEventTarget; unsigned int x :1 read_actionRichProviderId; unsigned int x :1 read_moduleInfo; unsigned int x :1 read_userActionEventKey; unsigned int x :1 read_userActionEventValue; unsigned int x :1 wrote_anyField; } _flags;
}
