...
@interface GEORPTdmInfo : PBCodable<NSCopying> {
  ...
  struct { unsigned int x :1 has_isBlocked; unsigned int x :1 read_unknownFields; unsigned int x :1 read_anonymousUserId; unsigned int x :1 read_baaCertificates; unsigned int x :1 read_baaSignature; unsigned int x :1 wrote_anyField; } _flags;
}
