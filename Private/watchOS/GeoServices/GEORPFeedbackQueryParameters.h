...
@interface GEORPFeedbackQueryParameters : PBCodable<NSCopying> {
  ...
  struct { unsigned int x :1 read_unknownFields; unsigned int x :1 read_feedbackComponentTypes; unsigned int x :1 read_componentQueryParameters; unsigned int x :1 read_filter; unsigned int x :1 wrote_anyField; } _flags;
}
