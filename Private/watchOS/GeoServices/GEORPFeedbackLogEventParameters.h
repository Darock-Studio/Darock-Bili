...
@interface GEORPFeedbackLogEventParameters : PBCodable<NSCopying> {
  ...
  struct { unsigned int x :1 has_type; unsigned int x :1 read_unknownFields; unsigned int x :1 read_clientEventUuid; unsigned int x :1 read_createdAt; unsigned int x :1 read_details; unsigned int x :1 wrote_anyField; } _flags;
}
