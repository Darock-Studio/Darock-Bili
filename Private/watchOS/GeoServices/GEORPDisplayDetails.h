...
@interface GEORPDisplayDetails : PBCodable<NSCopying> {
  ...
  struct { unsigned int x :1 has_displayStyle; unsigned int x :1 has_mapType; unsigned int x :1 read_unknownFields; unsigned int x :1 read_body; unsigned int x :1 read_displayRegion; unsigned int x :1 read_outreachLink; unsigned int x :1 read_places; unsigned int x :1 read_title; unsigned int x :1 wrote_anyField; } _flags;
}
