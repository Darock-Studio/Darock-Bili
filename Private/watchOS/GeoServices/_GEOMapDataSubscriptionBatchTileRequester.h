...
@interface _GEOMapDataSubscriptionBatchTileRequester : GEOBatchTileRequester<NSProgressReporting> {
  ...
  NSObject<GEOTileKeyEnumerator> *_tileKeysToLoad;
}
...
/* instance methods */
- (id)init;
- (id)initWithSubscription:(id)subscription diskCache:(id)cache reason:(unsigned char)reason requestOptions:(unsigned long long)options manifestManager:(id)manager log:(id)log logPrefix:(id)prefix tileRequesterCreationBlock:(id /* block */)block;
