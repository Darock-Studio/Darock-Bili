...
@interface GEOLogMsgEventCommuteWindow : PBCodable<NSCopying> {
  /* instance variables */
  struct { unsigned int x :1 has_startTime; unsigned int x :1 has_duration; unsigned int x :1 has_endReason; unsigned int x :1 has_numberOfAlertingResponses; unsigned int x :1 has_numberOfDoomRoutingRequests; unsigned int x :1 has_predictedExitTime; } _flags;
}
