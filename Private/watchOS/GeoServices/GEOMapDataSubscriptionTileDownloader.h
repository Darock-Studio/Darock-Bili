...
@property (weak, nonatomic) NSObject<GEOMapDataSubscriptionDataDownloaderDelegate> *delegate;
...
/* instance methods */
- (id)initWithSubscription:(id)subscription diskCache:(id)cache reason:(unsigned char)reason requestOptions:(unsigned long long)options manifestManager:(id)manager delegate:(id)delegate delegateQueue:(id)queue log:(id)log logPrefix:(id)prefix tileRequesterCreationBlock:(id /* block */)block;
- (void)resume;
- (void)pause;
- (void)cancel;
