...
@interface GEORequestResponseMetadata : PBCodable<NSCopying> {
  ...
  struct { unsigned int x :1 has_collectionTime; unsigned int x :1 has_sessionBatchIdBits; unsigned int x :1 read_unknownFields; unsigned int x :1 read_eventMetadata; unsigned int x :1 read_stateOffline; unsigned int x :1 read_stateUserSession; unsigned int x :1 wrote_anyField; } _flags;
}
