...
@interface GEOStopStepEVInfo : PBCodable<NSCopying> {
  /* instance variables */
  struct { unsigned int x :1 has_gainedBatteryPercentage; unsigned int x :1 has_muid; unsigned int x :1 has_remainingBatteryPercentage; unsigned int x :1 has_chargingTime; unsigned int x :1 has_gainedBatteryCharge; unsigned int x :1 has_gainedTravelRange; unsigned int x :1 has_zilchPathIndex; } _flags;
}
