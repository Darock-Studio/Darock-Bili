...
@interface GEORPPoiImageFeedbackContext : PBCodable<NSCopying> {
  ...
  struct { unsigned int x :1 read_unknownFields; unsigned int x :1 read_imageInfo; unsigned int x :1 read_imageUrl; unsigned int x :1 read_place; unsigned int x :1 read_providerImageId; unsigned int x :1 wrote_anyField; } _flags;
}
