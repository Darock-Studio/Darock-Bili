...
@interface GEOLPRPowerType : PBCodable<NSCopying> {
  ...
  struct { unsigned int x :1 read_key; unsigned int x :1 read_subtitles; unsigned int x :1 read_subtypes; unsigned int x :1 read_titles; unsigned int x :1 wrote_anyField; } _flags;
}
