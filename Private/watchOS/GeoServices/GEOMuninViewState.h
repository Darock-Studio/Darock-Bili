...
@interface GEOMuninViewState : PBCodable<NSCopying> {
  ...
  struct { unsigned int x :1 read_unknownFields; unsigned int x :1 read_cameraFrame; unsigned int x :1 read_locationInfo; unsigned int x :1 wrote_anyField; } _flags;
}
