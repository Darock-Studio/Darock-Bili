...
@interface GEORPAppAttestInfo : PBCodable<NSCopying> {
  ...
  struct { unsigned int x :1 read_unknownFields; unsigned int x :1 read_anonymousUserId; unsigned int x :1 read_assertion; unsigned int x :1 read_attestation; unsigned int x :1 read_keyId; unsigned int x :1 wrote_anyField; } _flags;
}
