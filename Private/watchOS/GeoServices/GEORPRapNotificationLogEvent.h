...
@interface GEORPRapNotificationLogEvent : PBCodable<NSCopying> {
  ...
  struct { unsigned int x :1 has_userInteractedWithNotification; unsigned int x :1 has_userShownNotification; unsigned int x :1 read_unknownFields; unsigned int x :1 read_originalRapId; unsigned int x :1 read_responseId; unsigned int x :1 wrote_anyField; } _flags;
}
