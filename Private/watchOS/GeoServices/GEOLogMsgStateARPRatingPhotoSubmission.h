...
@interface GEOLogMsgStateARPRatingPhotoSubmission : PBCodable<NSCopying> {
  /* instance variables */
  struct { unsigned int x :1 has_isFromMapsSuggesions; unsigned int x :1 has_isFromRecommendationCard; unsigned int x :1 has_isPlacecardInlineSubmission; } _flags;
}
