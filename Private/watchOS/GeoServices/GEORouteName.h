...
@interface GEORouteName : PBCodable<NSCopying> {
  ...
  struct { unsigned int x :1 has_lastZilchStitchedIndex; unsigned int x :1 read_unknownFields; unsigned int x :1 read_nameInfo; unsigned int x :1 read_nameRanges; unsigned int x :1 wrote_anyField; } _flags;
}
