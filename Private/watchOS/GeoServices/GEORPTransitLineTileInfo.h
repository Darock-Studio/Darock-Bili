...
@interface GEORPTransitLineTileInfo : PBCodable<NSCopying> {
  ...
  struct { unsigned int x :1 has_transitLineMuid; unsigned int x :1 read_transitLineName; unsigned int x :1 read_transitSystemName; unsigned int x :1 wrote_anyField; } _flags;
}
