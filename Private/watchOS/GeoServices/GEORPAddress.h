...
@interface GEORPAddress : PBCodable<NSCopying> {
  ...
  struct { unsigned int x :1 read_addressObject; unsigned int x :1 read_addressString; unsigned int x :1 read_geoAddress; unsigned int x :1 wrote_anyField; } _flags;
}
