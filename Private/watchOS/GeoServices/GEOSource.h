...
@interface GEOSource : PBCodable<NSCopying> {
  ...
  struct { unsigned int x :1 read_unknownFields; unsigned int x :1 read_sourceId; unsigned int x :1 read_sourceName; unsigned int x :1 read_sourceVersion; unsigned int x :1 wrote_anyField; } _flags;
}
