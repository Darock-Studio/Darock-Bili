...
@interface GEORPFeedbackSurveyResponse : PBCodable<NSCopying> {
  ...
  struct { unsigned int x :1 read_unknownFields; unsigned int x :1 read_optionDescription; unsigned int x :1 read_optionId; unsigned int x :1 wrote_anyField; } _flags;
}
