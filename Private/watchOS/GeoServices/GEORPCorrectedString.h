...
@interface GEORPCorrectedString : PBCodable<NSCopying> {
  ...
  struct { unsigned int x :1 read_unknownFields; unsigned int x :1 read_correctedValue; unsigned int x :1 read_originalValue; unsigned int x :1 wrote_anyField; } _flags;
}
