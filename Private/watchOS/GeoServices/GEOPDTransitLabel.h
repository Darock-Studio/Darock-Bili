...
@interface GEOPDTransitLabel : PBCodable<GEOTransitLabelItem, NSCopying> {
  ...
  struct { unsigned int x :1 has_labelType; unsigned int x :1 read_unknownFields; unsigned int x :1 read_labelArtwork; unsigned int x :1 read_labelTextString; unsigned int x :1 wrote_anyField; } _flags;
}

@property (readonly, nonatomic) unsigned long long type;
@property (readonly, nonatomic) NSString *labelString;
@property (readonly, @dynamic, nonatomic) NSObject<GEOTransitArtworkDataSource> *labelArtwork;
