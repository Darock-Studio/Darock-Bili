...
@interface GEORPIncidentAnnotationDetails : PBCodable<NSCopying> {
  ...
  struct { unsigned int x :1 has_annotationType; unsigned int x :1 has_incidentType; unsigned int x :1 read_incidentId; unsigned int x :1 read_incidentLocation; unsigned int x :1 read_userLocation; unsigned int x :1 wrote_anyField; } _flags;
}
