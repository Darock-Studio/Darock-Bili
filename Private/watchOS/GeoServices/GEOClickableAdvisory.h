...
@interface GEOClickableAdvisory : PBCodable<NSCopying> {
  ...
  struct { unsigned int x :1 read_unknownFields; unsigned int x :1 read_incidentIndexs; unsigned int x :1 read_advisoryMessage; unsigned int x :1 wrote_anyField; } _flags;
}
