...
@interface GEOABClientConfig : PBCodable<NSCopying> {
  ...
  struct { unsigned int x :1 read_unknownFields; unsigned int x :1 read_assignedAbBranchId; unsigned int x :1 read_configKeyValues; unsigned int x :1 read_debugExperimentBranchs; unsigned int x :1 wrote_anyField; } _flags;
}
