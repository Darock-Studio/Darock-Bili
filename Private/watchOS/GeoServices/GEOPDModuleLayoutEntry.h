...
@interface GEOPDModuleLayoutEntry : PBCodable<NSCopying> {
  ...
  struct { unsigned int x :1 has_platformType; unsigned int x :1 read_unknownFields; unsigned int x :1 read_applicationIds; unsigned int x :1 read_debugLayoutId; unsigned int x :1 read_modules; unsigned int x :1 wrote_anyField; } _flags;
}
