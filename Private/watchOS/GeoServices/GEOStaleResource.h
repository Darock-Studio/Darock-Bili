...
@interface GEOStaleResource : PBCodable<NSCopying> {
  ...
  struct { unsigned int x :1 has_originalTimestamp; unsigned int x :1 read_unknownFields; unsigned int x :1 read_desiredResource; unsigned int x :1 read_fallbackResource; unsigned int x :1 wrote_anyField; } _flags;
}
