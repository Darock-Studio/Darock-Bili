...
@interface GEOAlertNonRecommendedRouteText : PBCodable<NSCopying> {
  ...
  struct { unsigned int x :1 read_unknownFields; unsigned int x :1 read_body; unsigned int x :1 read_responseAlertPrimary; unsigned int x :1 read_responseAlertSecondary; unsigned int x :1 read_title; unsigned int x :1 wrote_anyField; } _flags;
}
