...
@interface GEOCategory : PBCodable<NSCopying> {
  ...
  struct { unsigned int x :1 has_geoOntologyId; unsigned int x :1 read_unknownFields; unsigned int x :1 read_alias; unsigned int x :1 read_localizedNames; unsigned int x :1 wrote_anyField; } _flags;
}
