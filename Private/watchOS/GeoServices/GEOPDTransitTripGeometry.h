...
@interface GEOPDTransitTripGeometry : PBCodable<NSCopying> {
  ...
  struct { unsigned int x :1 read_unknownFields; unsigned int x :1 read_tripStepIndexs; unsigned int x :1 read_tripLinks; unsigned int x :1 wrote_anyField; } _flags;
}
