...
@interface GEOTraitsTransitScheduleFilter : PBCodable<NSCopying> {
  ...
  struct { unsigned int x :1 read_unknownFields; unsigned int x :1 read_highFrequencyFilter; unsigned int x :1 read_lowFrequencyFilter; unsigned int x :1 read_operatingHoursRange; unsigned int x :1 wrote_anyField; } _flags;
}
