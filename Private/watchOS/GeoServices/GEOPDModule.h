...
@interface GEOPDModule : PBCodable<NSCopying> {
  ...
  struct { unsigned int x :1 has_moduleConfigurationIndex; unsigned int x :1 has_type; unsigned int x :1 read_unknownFields; unsigned int x :1 read_moduleDebugDescription; unsigned int x :1 read_options; unsigned int x :1 wrote_anyField; } _flags;
}
