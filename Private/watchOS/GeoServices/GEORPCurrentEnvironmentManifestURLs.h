...
@interface GEORPCurrentEnvironmentManifestURLs : PBCodable<NSCopying> {
  ...
  struct { unsigned int x :1 read_environmentDisplayName; unsigned int x :1 read_environmentReleaseName; unsigned int x :1 read_urls; unsigned int x :1 wrote_anyField; } _flags;
}
