...
@interface GEORPPoiActivityFeedback : PBCodable<NSCopying> {
  ...
  struct { unsigned int x :1 has_isDataCorrect; unsigned int x :1 has_isDataUseful; unsigned int x :1 has_isVisualRepresentationValid; unsigned int x :1 read_unknownFields; unsigned int x :1 read_representativeHours; unsigned int x :1 read_mapsId; unsigned int x :1 wrote_anyField; } _flags;
}
