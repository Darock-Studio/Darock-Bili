...
/* instance methods */
- (id)initWithService:(id)service isToDefaultPairedDevice:(BOOL)device messageSize:(unsigned long long)size linkType:(unsigned long long)type deliveryError:(unsigned long long)error RTT:(unsigned long long)rtt priority:(unsigned long long)priority;
@end
