...
/* instance methods */
- (id)initWithService:(id)service isToDefaultPairedDevice:(BOOL)device messageSize:(unsigned long long)size linkType:(unsigned long long)type priority:(unsigned long long)priority;
@end
