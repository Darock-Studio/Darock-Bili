...
//
#ifndef _TtC9SnippetUI18VisualResponseView_SnippetUI_h
#define _TtC9SnippetUI18VisualResponseView_SnippetUI_h
@import Foundation;

@interface SnippetUI.VisualResponseView (SnippetUI) <VRXVisualResponse>
/* instance methods */
- (id)description;
...
#endif /* _TtC9SnippetUI18VisualResponseView_SnippetUI_h */
