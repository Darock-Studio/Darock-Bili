...
@class FIUIUnitManager, NSCalendar, NSDate, NSLocale, NSString;
...
- (id)_buildKeyWithKeyBaseString:(id)string;
- (id)_buildKeyWithKeyBaseString:(id)string andSuffixes:(id)suffixes;
...
#endif /* AAUIAchievementLocalizationProvider_h */
