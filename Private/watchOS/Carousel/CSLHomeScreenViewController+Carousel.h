...
//
#ifndef CSLHomeScreenViewController_Carousel_h
#define CSLHomeScreenViewController_Carousel_h
@import Foundation;
...
@interface CSLHomeScreenViewController (Carousel) <FBSceneDelegate, CSLSensorActivityIndicatorSceneCoordinatorDelegate, CSLButtonTapAssertionHandler>
/* instance methods */
...
#endif /* CSLHomeScreenViewController_Carousel_h */
