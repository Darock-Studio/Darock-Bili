...
@interface CSLUIPBNumber : PBCodable<NSCopying> {
  /* instance variables */
  struct { unsigned int x :1 doubleValue; unsigned int x :1 int64Value; unsigned int x :1 floatValue; unsigned int x :1 int32Value; unsigned int x :1 boolValue; } _has;
}
