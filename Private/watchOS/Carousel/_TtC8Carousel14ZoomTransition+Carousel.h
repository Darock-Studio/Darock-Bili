...
//
#ifndef _TtC8Carousel14ZoomTransition_Carousel_h
#define _TtC8Carousel14ZoomTransition_Carousel_h
@import Foundation;
...
@interface Carousel.ZoomTransition (Carousel) <CSLCrownInputEventHandler>
/* instance methods */
- (void)handleCrownInputEvent:(id)event;
- (id)description;
@end

#endif /* _TtC8Carousel14ZoomTransition_Carousel_h */
