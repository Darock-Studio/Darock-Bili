...
//
#ifndef _TtC8Carousel30ApplicationViewControllerCache_Carousel_h
#define _TtC8Carousel30ApplicationViewControllerCache_Carousel_h
@import Foundation;
...
@interface Carousel.ApplicationViewControllerCache (Carousel) <CSLMainUIApplicationViewControllerCaching>
/* instance methods */
- (id)applicationViewControllerForBundleIdentifier:(id)identifier;
- (id)switcherContainerViewControllerForSwitcherItem:(id)item;
@end

#endif /* _TtC8Carousel30ApplicationViewControllerCache_Carousel_h */
