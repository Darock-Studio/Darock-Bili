...
//
#ifndef WNUIAlertModel_Carousel_h
#define WNUIAlertModel_Carousel_h
@import Foundation;
...
@interface WNUIAlertModel (Carousel)
/* instance methods */
- (BOOL)csl_hasVisiblePhoneCall;
@end

#endif /* WNUIAlertModel_Carousel_h */
