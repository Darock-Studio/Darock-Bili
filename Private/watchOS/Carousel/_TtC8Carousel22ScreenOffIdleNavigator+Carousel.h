...
//
#ifndef _TtC8Carousel22ScreenOffIdleNavigator_Carousel_h
#define _TtC8Carousel22ScreenOffIdleNavigator_Carousel_h
@import Foundation;
...
@interface Carousel.ScreenOffIdleNavigator (Carousel) <CSLMainUIPolicy, BLSHBacklightHostObserving>
/* instance methods */
- (void)backlight:(id)backlight didCompleteUpdateToState:(long long)state forEvent:(id)event;
- (void)didSettle:(id)settle;
@end

#endif /* _TtC8Carousel22ScreenOffIdleNavigator_Carousel_h */
