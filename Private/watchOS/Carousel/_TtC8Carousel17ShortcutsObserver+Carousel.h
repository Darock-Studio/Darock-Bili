...
//
#ifndef _TtC8Carousel17ShortcutsObserver_Carousel_h
#define _TtC8Carousel17ShortcutsObserver_Carousel_h
@import Foundation;
...
@interface Carousel.ShortcutsObserver (Carousel) <CSLSMobileKeyBagObserver>
/* instance methods */
- (void)keybagDidUnlockForTheFirstTime:(id)time;
@end

#endif /* _TtC8Carousel17ShortcutsObserver_Carousel_h */
