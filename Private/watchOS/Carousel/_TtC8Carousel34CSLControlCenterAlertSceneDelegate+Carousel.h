...
//
#ifndef _TtC8Carousel34CSLControlCenterAlertSceneDelegate_Carousel_h
#define _TtC8Carousel34CSLControlCenterAlertSceneDelegate_Carousel_h
@import Foundation;
...
@interface Carousel.CSLControlCenterAlertSceneDelegate (Carousel) <Carousel.CSLAlertSceneDelegateClass, UIWindowSceneDelegate, WNUIAlertSceneDelegate>
/* class methods */
+ (id)alertIdentity;
...
#endif /* _TtC8Carousel34CSLControlCenterAlertSceneDelegate_Carousel_h */
