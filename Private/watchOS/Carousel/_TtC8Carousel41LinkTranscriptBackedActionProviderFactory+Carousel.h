...
//
#ifndef _TtC8Carousel41LinkTranscriptBackedActionProviderFactory_Carousel_h
#define _TtC8Carousel41LinkTranscriptBackedActionProviderFactory_Carousel_h
@import Foundation;
...
@interface Carousel.LinkTranscriptBackedActionProviderFactory (Carousel) <CSLSMobileKeyBagObserver>
/* instance methods */
- (void)keybagDidUnlockForTheFirstTime:(id)time;
@end

#endif /* _TtC8Carousel41LinkTranscriptBackedActionProviderFactory_Carousel_h */
