...
//
#ifndef LNActionParameterMetadata_Carousel_h
#define LNActionParameterMetadata_Carousel_h
@import Foundation;
...
@interface LNActionParameterMetadata (Carousel)
/* instance methods */
- (id)csl_entityTypeIdentifier;
- (id)csl_enumTypeIdentifier;
@end

#endif /* LNActionParameterMetadata_Carousel_h */
