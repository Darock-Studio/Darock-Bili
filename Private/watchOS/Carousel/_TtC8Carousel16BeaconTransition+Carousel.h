...
//
#ifndef _TtC8Carousel16BeaconTransition_Carousel_h
#define _TtC8Carousel16BeaconTransition_Carousel_h
@import Foundation;
...
@interface Carousel.BeaconTransition (Carousel) <CSLCrownInputEventHandler>
/* instance methods */
- (void)handleCrownInputEvent:(id)event;
@end

#endif /* _TtC8Carousel16BeaconTransition_Carousel_h */
