...
//
#ifndef CSLStingActionProvider_Carousel_h
#define CSLStingActionProvider_Carousel_h
@import Foundation;
...
@interface CSLStingActionProvider (Carousel) <CSLLinkActionObserver>
/* instance methods */
- (void)linkActionsChanged;
@end

#endif /* CSLStingActionProvider_Carousel_h */
