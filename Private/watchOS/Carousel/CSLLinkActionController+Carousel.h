...
//
#ifndef CSLLinkActionController_Carousel_h
#define CSLLinkActionController_Carousel_h
@import Foundation;
...
@interface CSLLinkActionController (Carousel) <CSLPRFStingConfigurationDelegate, CSLSessionObserver, CSLLinkActionExecutorDelegate>
/* instance methods */
...
#endif /* CSLLinkActionController_Carousel_h */
