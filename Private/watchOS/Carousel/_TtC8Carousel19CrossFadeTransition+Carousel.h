...
//
#ifndef _TtC8Carousel19CrossFadeTransition_Carousel_h
#define _TtC8Carousel19CrossFadeTransition_Carousel_h
@import Foundation;
...
@interface Carousel.CrossFadeTransition (Carousel) <CSLCrownInputEventHandler>
/* instance methods */
- (void)handleCrownInputEvent:(id)event;
@end

#endif /* _TtC8Carousel19CrossFadeTransition_Carousel_h */
