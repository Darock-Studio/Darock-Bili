...
//
#ifndef _TtC8Carousel21AppSwitcherTransition_Carousel_h
#define _TtC8Carousel21AppSwitcherTransition_Carousel_h
@import Foundation;
...
@interface Carousel.AppSwitcherTransition (Carousel) <CSLCrownInputEventHandler, CSLPIButtonHandlerProtocol>
/* instance methods */
- (BOOL)handleButton:(unsigned long long)button eventType:(unsigned long long)type;
- (void)handleCrownInputEvent:(id)event;
@end

#endif /* _TtC8Carousel21AppSwitcherTransition_Carousel_h */
