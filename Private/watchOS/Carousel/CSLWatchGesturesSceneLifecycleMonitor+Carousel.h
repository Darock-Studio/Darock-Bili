...
//
#ifndef CSLWatchGesturesSceneLifecycleMonitor_Carousel_h
#define CSLWatchGesturesSceneLifecycleMonitor_Carousel_h
@import Foundation;
...
@interface CSLWatchGesturesSceneLifecycleMonitor (Carousel) <FBSceneObserver, CSLSceneMonitorDelegate>
/* instance methods */
...
#endif /* CSLWatchGesturesSceneLifecycleMonitor_Carousel_h */
