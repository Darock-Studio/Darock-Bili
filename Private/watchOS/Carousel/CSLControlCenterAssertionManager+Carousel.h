...
//
#ifndef CSLControlCenterAssertionManager_Carousel_h
#define CSLControlCenterAssertionManager_Carousel_h
@import Foundation;
...
@interface CSLControlCenterAssertionManager (Carousel)
/* instance methods */
- (id)acquireBackdropAssertion:(id)assertion error:(id *)error;
@end

#endif /* CSLControlCenterAssertionManager_Carousel_h */
