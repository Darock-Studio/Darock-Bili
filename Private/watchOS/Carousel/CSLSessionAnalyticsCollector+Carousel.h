...
//
#ifndef CSLSessionAnalyticsCollector_Carousel_h
#define CSLSessionAnalyticsCollector_Carousel_h
@import Foundation;
...
@interface CSLSessionAnalyticsCollector (Carousel) <CSLSessionObserver, CSLMidnightObserver>
/* instance methods */
- (void)midnightPassed;
- (void)sessionManager:(id)manager sessionDidEnd:(id)end;
@end

#endif /* CSLSessionAnalyticsCollector_Carousel_h */
