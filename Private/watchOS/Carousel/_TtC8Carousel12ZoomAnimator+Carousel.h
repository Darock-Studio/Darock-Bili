...
//
#ifndef _TtC8Carousel12ZoomAnimator_Carousel_h
#define _TtC8Carousel12ZoomAnimator_Carousel_h
@import Foundation;
...
@interface Carousel.ZoomAnimator (Carousel) <CSLCrownInputEventHandler>
/* instance methods */
- (void)handleCrownInputEvent:(id)event;
@end

#endif /* _TtC8Carousel12ZoomAnimator_Carousel_h */
