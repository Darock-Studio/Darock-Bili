...
//
#ifndef _TtC8Carousel26InitialConnectivityManager_Carousel_h
#define _TtC8Carousel26InitialConnectivityManager_Carousel_h
@import Foundation;
...
@interface Carousel.InitialConnectivityManager (Carousel)
/* instance methods */
- (void)toggleLowPowerModeOverride;
- (void)toggleConnectedAndwaitingOverride;
- (void)sendInitialConnectivityCompleteNotification;
- (void)sendInitialConnectivityCompleteNotificationWithNote:(id)note;
@end

#endif /* _TtC8Carousel26InitialConnectivityManager_Carousel_h */
