...
//
#ifndef CSLControlCenterAnalytics_Carousel_h
#define CSLControlCenterAnalytics_Carousel_h
@import Foundation;
...
@interface CSLControlCenterAnalytics (Carousel) <CSLControlCenterStateObserving, CSLMidnightObserver>
/* instance methods */
- (void)midnightPassed;
- (void)service:(id)service changedState:(unsigned long long)state;
@end

#endif /* CSLControlCenterAnalytics_Carousel_h */
