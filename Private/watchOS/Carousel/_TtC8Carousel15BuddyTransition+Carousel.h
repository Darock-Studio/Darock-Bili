...
//
#ifndef _TtC8Carousel15BuddyTransition_Carousel_h
#define _TtC8Carousel15BuddyTransition_Carousel_h
@import Foundation;
...
@interface Carousel.BuddyTransition (Carousel) <CSLPIButtonHandlerProtocol, CSLCrownInputEventHandler>
/* instance methods */
- (void)handleCrownInputEvent:(id)event;
- (BOOL)handleButton:(unsigned long long)button eventType:(unsigned long long)type;
@end

#endif /* _TtC8Carousel15BuddyTransition_Carousel_h */
