...
//
#ifndef CSLDepthSessionAutoLaunchAuthorizationAlert_Carousel_h
#define CSLDepthSessionAutoLaunchAuthorizationAlert_Carousel_h
@import Foundation;
...
@interface CSLDepthSessionAutoLaunchAuthorizationAlert (Carousel) <CSLSessionAutoLaunchAuthorizationAlert>
/* instance methods */
- (void)showWithCompletion:(id /* block */)completion;
@end

#endif /* CSLDepthSessionAutoLaunchAuthorizationAlert_Carousel_h */
