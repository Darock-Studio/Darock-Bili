...
//
#ifndef CSLControlCenterManager_Carousel_h
#define CSLControlCenterManager_Carousel_h
@import Foundation;
...
@interface CSLControlCenterManager (Carousel) <CSLScrollCenterTransitionValidator, CSLControlCenterPreventionAssertionProviding>
/* instance methods */
...
#endif /* CSLControlCenterManager_Carousel_h */
