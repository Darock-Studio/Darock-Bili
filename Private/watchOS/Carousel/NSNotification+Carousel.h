...
//
#ifndef NSNotification_Carousel_h
#define NSNotification_Carousel_h
@import Foundation;
...
@interface NSNotification (Carousel)
/* class methods */
+ (id)CSLLinkActionControllerWorkoutStateChangedNotification;
@end

#endif /* NSNotification_Carousel_h */
