...
@class LPLinkMetadata, NSArray, NSError, NSItemProvider, NSNumber, NSString, NSURL, NSUUID;
...
/* instance methods */
- (id)initWithFileURL:(id)url itemProvider:(id)provider activityItem:(id)item defaultCollaboration:(BOOL)collaboration managedFileURL:(id)url;
