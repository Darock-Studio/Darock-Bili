...
//
#ifndef RUIWatchScrollWheel_h
#define RUIWatchScrollWheel_h
@import Foundation;
...
@interface RUIWatchScrollWheel : UIView<UIScrollViewDelegate> {
  /* instance variables */
...
@property (weak, nonatomic) NSObject<RUIWatchScrollWheelDataSource> *dataSource;
@property (weak, nonatomic) NSObject<RUIWatchScrollWheelDelegate> *delegate;
