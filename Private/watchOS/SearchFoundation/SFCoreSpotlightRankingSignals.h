...
@interface SFCoreSpotlightRankingSignals : NSObject<SFCoreSpotlightRankingSignals, NSSecureCoding, NSCopying> {
  /* instance variables */
  struct { unsigned int x :1 wasNominatedAsTopHit; unsigned int x :1 isExactMatchOfLaunchString; unsigned int x :1 wasEngagedInSpotlight; unsigned int x :1 resultQueryRecency; } _has;
}
