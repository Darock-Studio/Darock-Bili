...
@interface PSGPBError : PBCodable<NSCopying> {
  /* instance variables */
  struct { unsigned int x :1 errorType; unsigned int x :1 maxPredictionItems; unsigned int x :1 maxStructuredInfoItems; unsigned int x :1 maxTextualResponseItems; unsigned int x :1 triggerSourceType; unsigned int x :1 hasContextBeforeInput; unsigned int x :1 hasRecipientNames; unsigned int x :1 hasResponseContext; unsigned int x :1 isDocumentEmpty; unsigned int x :1 isResponseContextBlacklisted; } _has;
}
