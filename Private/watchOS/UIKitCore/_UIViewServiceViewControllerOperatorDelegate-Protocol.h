...
//
#ifndef _UIViewServiceViewControllerOperatorDelegate_Protocol_h
#define _UIViewServiceViewControllerOperatorDelegate_Protocol_h
@import Foundation;
...
#endif /* _UIViewServiceViewControllerOperatorDelegate_Protocol_h */
