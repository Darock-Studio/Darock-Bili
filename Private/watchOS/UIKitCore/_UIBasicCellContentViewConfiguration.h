...
@interface _UIBasicCellContentViewConfiguration : NSObject<_UIContentViewConfiguration, NSSecureCoding> {
  /* instance variables */
  struct { unsigned int x :1 hasCustomizedAxesPreservingSuperviewLayoutMargins; unsigned int x :1 hasCustomizedDirectionalLayoutMargins; unsigned int x :1 hasCustomizedImageToTextPadding; } _configurationFlags;
