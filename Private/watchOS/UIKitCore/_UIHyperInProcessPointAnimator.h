...
@property (nonatomic) BOOL _regionChangedDiscontinuouslyOnChange;
...
@property (nonatomic) BOOL _generatesFeedbackWhenBoundaryIsCrossed;
...
- (void)_setGeneratesFeedbackWhenBoundaryIsCrossed:(BOOL)crossed;
- (void)_setRegionChangedDiscontinuouslyOnChange:(BOOL)change;
@end
