...
/* instance methods */
- (id)initWithImage:(id)image size:(struct CGSize { double x0; double x1; })size scale:(BOOL)scale position:(BOOL)position renderLast:(id)last orientToCamera:(id)camera rotation:(id)rotation;
