...
/* instance methods */
- (id)initWithDelegate:(id)delegate mode:(unsigned int)mode parameters:(struct VCRedundancyControllerVideoParameters_t { id x0; unsigned int x1; BOOL x2; unsigned char x3; })parameters;
- (void)dealloc;
