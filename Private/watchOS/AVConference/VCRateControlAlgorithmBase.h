...
@interface VCRateControlAlgorithmBase : NSObject<VCRateControlAlgorithm> {
  /* instance variables */
  struct tagVCRateControlAlgorithmVTable { undefined *configure; undefined *doRateControl; undefined *stateEnter; undefined *stateExit; } _vTable;
  atomic BOOL _paused;
  ...
  BOOL _isOvershoot;
  struct { double x[100] time; double x[100] owrd; int frontIndex; int rearIndex; unsigned int size; double nowrd; double nowrdShort; double nowrdAcc; BOOL isOWRDListTooShortDuringInitialRampUp; } _owrdList;
  ...
  Count"S"ecnCECount"S}} x[64{tagVCRateControlLossEvent="time"d"packetLossRate"d"packetLossRateVideo"d"isLossIncreasing"B"ecnStats"{tagVCStatisticsECNStats="ecnECT1] _lossEventBuffer;
