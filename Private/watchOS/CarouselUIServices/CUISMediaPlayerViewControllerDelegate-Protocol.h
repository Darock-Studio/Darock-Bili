...
//
#ifndef CUISMediaPlayerViewControllerDelegate_Protocol_h
#define CUISMediaPlayerViewControllerDelegate_Protocol_h
@import Foundation;
...
#endif /* CUISMediaPlayerViewControllerDelegate_Protocol_h */
