...
@interface RequestDispatcherBridges.AssistantSpeechRecognizerResponseHandler : RequestDispatcherBridges.SpeechRecognizerResponseHandler { // (Swift)
  /* instance variables */
   myriadMonitor;
   userId;
   requestQueue;
...
#endif /* _TtC24RequestDispatcherBridges40AssistantSpeechRecognizerResponseHandler_h */
