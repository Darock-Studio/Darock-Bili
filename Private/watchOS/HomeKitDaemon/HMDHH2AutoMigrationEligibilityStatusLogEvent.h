...
/* instance methods */
- (id)initWithAutoMigrationEligibilityResult:(id)result migrationByOwnerManualEligibilityResult:(id)result migrationByOwnerAutoEligibilityResult:(id)result didRunMigrationTaskOnCurrentBuild:(BOOL)build currentBuildStartedOnHH1:(BOOL)hh1;
@end
