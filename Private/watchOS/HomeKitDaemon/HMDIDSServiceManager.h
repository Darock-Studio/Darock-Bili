...
@property (readonly) NSObject<HMDIDSService> *legacyService;
...
/* instance methods */
- (id)initWithDefaults;
- (id)initWithMainService:(id)service legacyService:(id)service proxyService:(id)service streamService:(id)service notificationCenter:(id)center;
