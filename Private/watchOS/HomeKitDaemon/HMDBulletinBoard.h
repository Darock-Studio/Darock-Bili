...
+ (void)messageAndTitleForLockUserChangeEvent:(id *)event title:(id *)title accessory:(id)accessory lockDataType:(unsigned char)type dataOperationType:(unsigned char)type ecosystemName:(id)name isAffectedUser:(BOOL)user;
+ (id)logCategory;
...
- (void)insertBulletinForLockOperation:(id)operation userDisplayName:(id)name lockOperationType:(unsigned char)type ecosystemName:(id)name flow:(id)flow;
- (void)insertBulletinForLockUserChange:(id)change lockDataType:(unsigned char)type dataOperationType:(unsigned char)type ecosystemName:(id)name isAffectedUser:(BOOL)user flow:(id)flow;
