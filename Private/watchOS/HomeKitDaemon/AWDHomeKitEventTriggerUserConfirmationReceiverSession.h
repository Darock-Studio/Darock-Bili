...
@interface AWDHomeKitEventTriggerUserConfirmationReceiverSession : PBCodable<NSCopying> {
  /* instance variables */
  struct { unsigned int x :1 timestamp; unsigned int x :1 userResponseDelay; unsigned int x :1 resultErrorCode; } _has;
}
...
#endif /* AWDHomeKitEventTriggerUserConfirmationReceiverSession_h */
