...
@interface AWDHomeKitCameraRecordingClipNotification : PBCodable<NSCopying> {
  /* instance variables */
  struct { unsigned int x :1 duration; unsigned int x :1 recordingEventTriggers; unsigned int x :1 sequenceNumber; unsigned int x :1 timestamp; } _has;
}
...
#endif /* AWDHomeKitCameraRecordingClipNotification_h */
