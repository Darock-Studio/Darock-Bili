...
@interface AWDHomeKitTargetControllerCommand : PBCodable<NSCopying> {
  /* instance variables */
  struct { unsigned int x :1 timestamp; unsigned int x :1 certified; unsigned int x :1 command; unsigned int x :1 transportType; } _has;
}
...
#endif /* AWDHomeKitTargetControllerCommand_h */
