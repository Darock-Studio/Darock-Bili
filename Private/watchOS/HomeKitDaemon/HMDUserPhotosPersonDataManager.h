...
@class HMFMessageDispatcher, HMPhotosPersonManagerSettings, NSNotificationCenter, NSString, NSUUID;
...
/* instance methods */
- (id)initWithUser:(id)user messageDispatcher:(id)dispatcher workQueue:(id)queue;
- (id)initWithUser:(id)user messageDispatcher:(id)dispatcher backingStoreContext:(id)context cloudTransform:(id)transform workQueue:(id)queue supportsFaceClassification:(BOOL)classification notificationCenter:(id)center cloudPhotosSettingObserver:(id)observer;
- (void)configure;
