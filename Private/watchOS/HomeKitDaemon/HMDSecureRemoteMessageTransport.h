...
@property (retain) NSObject<HMDUserDeviceCapabilitiesRequestManager> *userDeviceCapabilitiesRequestManager;
...
- (void)configureWithUserDeviceCapabilitiesRequestManager:(id)manager deviceResidencyProvider:(id)provider;
- (id)start;
- (void)reset;
- (void)_reset;
