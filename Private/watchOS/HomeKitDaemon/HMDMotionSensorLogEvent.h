...
/* instance methods */
- (id)initWithMotionSensorStatus:(id)status accessoryUUID:(id)uuid characteristicUUID:(id)uuid timeStamp:(id)stamp homeUUID:(id)uuid homePresence:(id)presence triggerSource:(id)source bundleId:(id)id userUUID:(id)uuid;
@end

#endif /* HMDMotionSensorLogEvent_h */
