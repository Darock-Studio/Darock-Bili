...
@property BOOL eventLogHomeSettingEnabled;
...
+ (id)createNewHomeModelsWithModelID:(id)id parentModelID:(id)id name:(id)name ownedBy:(id)by;
...
- (void)clearEventsWithCompletion:(id /* block */)completion;
...
- (id)saveUserUniqueID:(id)id ForUser:(id)user flow:(id)flow;
...
- (BOOL)enableBulletinRegistrations:(id)registrations source:(id)source user:(id)user context:(id)context;
- (void)disableBulletinRegistrations:(id)registrations source:(id)source user:(id)user context:(id)context;
- (void)maybeRemoveStaleRegistrationsFromPreviousUserForSource:(id)source user:(id)user context:(id)context;
- (id)findBulletinRegistration:(id)registration source:(id)source user:(id)user context:(id)context;
- (BOOL)insertOrUpdateCharacteristicBulletinRegistration:(id)registration source:(id)source managedBulletinRegistration:(id)registration accessory:(id)accessory user:(id)user context:(id)context;
...
- (BOOL)addElement:(id)element toCondition:(id)condition isStartElement:(BOOL)element;
- (BOOL)addTimeOfDayTimePeriodElement:(id)element toCondition:(id)condition isStartElement:(BOOL)element;
- (BOOL)addSunriseSunSetTimePeriodElement:(id)element toCondition:(id)condition isStartElement:(BOOL)element;
- (BOOL)addPresenceBulletinCondition:(id)condition on:(id)on;
- (BOOL)insertOrUpdateCameraSignificantEventBulletinRegistration:(id)registration source:(id)source managedBulletinRegistration:(id)registration accessory:(id)accessory user:(id)user context:(id)context;
- (BOOL)insertOrUpdateCameraReachabilityBulletinRegistration:(id)registration source:(id)source managedBulletinRegistration:(id)registration accessory:(id)accessory user:(id)user context:(id)context;
...
- (BOOL)insertOrUpdateCameraAccessModeBulletinRegistration:(id)registration source:(id)source managedBulletinRegistration:(id)registration accessory:(id)accessory user:(id)user context:(id)context;
...
- (void)_auditActionSetsAndTriggers:(id)triggers;
...
- (void)_waitForResidentNewAccessoryUpdateWithServer:(id)server pairingEvent:(id)event callback:(id /* block */)callback;
...
- (id)_characteristicUpdatesByDestinationForNotificationRegistryDestinations:(id)destinations bulletinDestinations:(id)destinations broadcast:(BOOL)broadcast;
- (id)_pushTokenToDestinationMappingForDestinations:(id)destinations;
- (id)_characteristicUpdatesForChangedCharacteristics:(id)characteristics bulletinCharacteristics:(id)characteristics broadcast:(BOOL)broadcast;
...
- (BOOL)_validateSettingsUpdate:(id)update type:(long long *)type keyPath:(id *)path value:(id *)value error:(id *)error;
...
- (id)backingStoreObjects:(long long)objects hh2Migration:(BOOL)migration;
