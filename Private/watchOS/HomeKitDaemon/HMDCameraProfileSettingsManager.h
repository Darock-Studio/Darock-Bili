...
/* instance methods */
- (id)initWithUniqueIdentifier:(id)identifier hapAccessory:(id)accessory workQueue:(id)queue coreDataAdapter:(id)adapter notificationCenter:(id)center bulletinBoard:(id)board characteristicsAvailabilityListener:(id)listener featuresDataSource:(id)source accountManager:(id)manager;
