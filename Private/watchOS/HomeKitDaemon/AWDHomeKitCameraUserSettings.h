...
@interface AWDHomeKitCameraUserSettings : PBCodable<NSCopying> {
  /* instance variables */
  struct { unsigned int x :1 isImportingFromPhotoLibraryEnabled; unsigned int x :1 isOwner; unsigned int x :1 isSharingFaceClassificationsEnabled; } _has;
}
...
#endif /* AWDHomeKitCameraUserSettings_h */
