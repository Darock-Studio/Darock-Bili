...
@interface AWDHomeKitUserPresenceAuthorization : PBCodable<NSCopying> {
  /* instance variables */
  struct { unsigned int x :1 timestamp; unsigned int x :1 auth; } _has;
}
...
/* instance methods */
- (id)authAsString:(int)string;
- (int)StringAsAuth:(id)auth;
- (id)description;
...
#endif /* AWDHomeKitUserPresenceAuthorization_h */
