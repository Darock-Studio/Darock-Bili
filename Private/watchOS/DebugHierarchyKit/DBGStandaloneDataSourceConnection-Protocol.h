...
//
#ifndef DBGStandaloneDataSourceConnection_Protocol_h
#define DBGStandaloneDataSourceConnection_Protocol_h
@import Foundation;
...
#endif /* DBGStandaloneDataSourceConnection_Protocol_h */
