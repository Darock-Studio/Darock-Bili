...
@property (readonly, nonatomic) NSObject<CNScheduler> *alreadyOffMainThreadScheduler;
@property (readonly, nonatomic) NSObject<CNScheduler> *needToGetOffMainThreadScheduler;
