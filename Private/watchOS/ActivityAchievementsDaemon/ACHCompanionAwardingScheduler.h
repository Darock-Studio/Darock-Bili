...
@interface ACHCompanionAwardingScheduler : NSObject<HDPeriodicActivityDelegate, HDHealthDaemonReadyObserver, HDDiagnosticObject, ACHTemplateStoreObserving, ACHDataStoreObserving, ACHAwardingScheduler>
...
- (BOOL)_userInfoContainsCompanionActivityBundleID:(id)id;
