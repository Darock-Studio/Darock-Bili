...
/* instance methods */
- (id)initWithDoorStatus:(id)status accessoryUUID:(id)uuid characteristicUUID:(id)uuid timeStamp:(id)stamp homeUUID:(id)uuid homePresence:(id)presence triggerSource:(id)source bundleId:(id)id userUUID:(id)uuid;
@end

#endif /* HMDDoorLogEvent_h */
