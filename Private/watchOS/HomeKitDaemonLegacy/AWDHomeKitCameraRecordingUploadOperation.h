...
@interface AWDHomeKitCameraRecordingUploadOperation : PBCodable<NSCopying> {
  /* instance variables */
  struct { unsigned int x :1 errorCode; unsigned int x :1 operationStartTime; unsigned int x :1 retryCount; unsigned int x :1 runTime; unsigned int x :1 timestamp; unsigned int x :1 totalClipDuration; unsigned int x :1 operationType; unsigned int x :1 didCausePreviousClipToFinalizeBecauseMaxDurationExceeded; } _has;
}
...
#endif /* AWDHomeKitCameraRecordingUploadOperation_h */
