...
/* instance methods */
- (id)initWithReachability:(BOOL)reachability didCreateEventModel:(BOOL)model reachabilityChangeDebounceCount:(unsigned long long)count offlineDuration:(double)duration hapAccessory:(id)accessory;
@end
