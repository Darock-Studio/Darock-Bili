...
@class HMAccessoryCapabilities, HMDAudioAnalysisEventSubscriber, HMDAudioAnalysisRequestManager, HMFActivity, HMFPairingIdentity, HMFSoftwareVersion, HMFWiFiManager, HMFWiFiNetworkInfo, HMMediaDestination, HMMediaDestinationControllerData, HMSoftwareUpdateDescriptor, HMSoftwareUpdateProgress, NSArray, NSData, NSHashTable, NSString, NSUUID;
@protocol HMELastEventStoreReadHandle, HMESubscriptionProviding, HMMLogEventSubmitting, OS_os_log;
...
@property (readonly) NSObject<HMDAppleMediaAccessoryModelDataSource> *modelDataSource;
