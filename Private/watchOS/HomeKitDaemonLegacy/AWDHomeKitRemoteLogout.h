...
@interface AWDHomeKitRemoteLogout : PBCodable<NSCopying> {
  /* instance variables */
  struct { unsigned int x :1 delay; unsigned int x :1 timestamp; unsigned int x :1 requester; unsigned int x :1 resultErrorCode; } _has;
}
...
#endif /* AWDHomeKitRemoteLogout_h */
