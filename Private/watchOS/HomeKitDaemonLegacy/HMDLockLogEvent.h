...
/* instance methods */
- (id)initWithLockStatus:(id)status accessoryUUID:(id)uuid characteristicUUID:(id)uuid timeStamp:(id)stamp homeUUID:(id)uuid homePresence:(id)presence triggerSource:(id)source bundleId:(id)id userUUID:(id)uuid;
@end

#endif /* HMDLockLogEvent_h */
