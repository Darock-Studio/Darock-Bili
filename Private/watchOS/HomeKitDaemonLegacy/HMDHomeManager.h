...
@class BOOL *, HMDAppleAccessoryPairingController, HMDHomeManagerObjectChangeHandler, HMEDelegatingEventRouter, HMELastEventStore, HMEMemoryEventBus, HMFActivity, HMFBoolean, HMFDumpCategory, HMFNetMonitor, HMFTimer, HMMLogEventDispatcher, NSArray, NSDate, NSMapTable, NSMutableArray, NSMutableDictionary, NSMutableSet, NSNotificationCenter, NSSet, NSString, NSUUID, NSUserDefaults;
...
+ (BOOL)isThisDeviceAdminOfHome:(id)home;
...
- (id)_homeDataForPersistentStoreIncrementingGeneration:(BOOL)generation reason:(id)reason;
...
- (BOOL)operationsWithIdentifiers:(id)identifiers outOperations:(id *)operations;
...
- (BOOL)_addWatch:(id)watch toAssociatedList:(id)list;
...
- (void)_updateAccessAllowedWhenLocked:(BOOL)locked message:(id)message;
