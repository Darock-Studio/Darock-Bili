...
@interface AWDHomeKitConfigurationData : PBCodable<NSCopying> {
  /* instance variables */
  struct { unsigned int x :1 timestamp; unsigned int x :1 databaseSize; unsigned int x :1 metadataVersion; unsigned int x :1 hasActiveWatchDevice; unsigned int x :1 hasWatchDevice; unsigned int x :1 isDemoConfiguration; unsigned int x :1 isResidentCapable; unsigned int x :1 isResidentEnabled; } _has;
}
...
- (void)addHomeConfigurations:(id)configurations;
- (unsigned long long)homeConfigurationsCount;
- (id)homeConfigurationsAtIndex:(unsigned long long)index;
- (id)description;
...
#endif /* AWDHomeKitConfigurationData_h */
