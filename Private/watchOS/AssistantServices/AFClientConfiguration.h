...
- (id)init;
- (id)initWithAccessibilityState:(id)state deviceRingerSwitchState:(long long)state isDeviceInCarDNDMode:(BOOL)dndmode isDeviceInStarkMode:(BOOL)mode isDeviceWatchAuthenticated:(BOOL)authenticated areAnnouncementRequestsPermittedByPresentationWhileActive:(BOOL)active outputVolume:(float)volume tapToSiriAudioPlaybackRequest:(id)request twoShotAudioPlaybackRequest:(id)request deviceSetupFlowBeginDate:(id)date deviceSetupFlowEndDate:(id)date;
- (id)description;
