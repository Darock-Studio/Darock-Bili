...
- (id)init;
- (id)initWithPlaybackState:(long long)state nowPlayingTimestamp:(id)timestamp mediaType:(id)type groupIdentifier:(id)identifier isProxyGroupPlayer:(BOOL)player;
