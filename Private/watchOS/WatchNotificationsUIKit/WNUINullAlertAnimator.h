...
//
#ifndef WNUINullAlertAnimator_h
#define WNUINullAlertAnimator_h
@import Foundation;
...
@interface WNUINullAlertAnimator : NSObject<CUISAlertAnimatedTransitioning>
