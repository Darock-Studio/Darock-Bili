...
@interface MHSchemaMHStatisticDistributionInfo : SISchemaInstrumentationMessage {
  /* instance variables */
  struct { unsigned int x :1 num; unsigned int x :1 max; unsigned int x :1 min; unsigned int x :1 avg; unsigned int x :1 median; unsigned int x :1 p95; unsigned int x :1 std; unsigned int x :1 warmup; } _has;
}
