...
@interface MHSchemaMHRaiseToSpeakSecondPassPolicyDecisionMade : SISchemaInstrumentationMessage {
  /* instance variables */
  struct { unsigned int x :1 isSecondPassTriggered; unsigned int x :1 speakingProbability; unsigned int x :1 processedAudioDurationInMs; unsigned int x :1 isReplayModeEnabled; } _has;
}
