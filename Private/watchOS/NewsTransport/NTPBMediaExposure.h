...
@interface NTPBMediaExposure : PBCodable<NSCopying> {
  /* instance variables */
  struct { unsigned int x :1 backendArticleVersionInt64; unsigned int x :1 personalizationTreatmentId; unsigned int x :1 previousArticlePublisherArticleVersion; unsigned int x :1 publisherArticleVersionInt64; unsigned int x :1 articleType; unsigned int x :1 backendArticleVersion; unsigned int x :1 countOfImagesExposed; unsigned int x :1 countOfImagesInGallery; unsigned int x :1 feedCellSection; unsigned int x :1 feedType; unsigned int x :1 galleryType; unsigned int x :1 mediaLocation; unsigned int x :1 mediaType; unsigned int x :1 publisherArticleVersion; unsigned int x :1 videoType; unsigned int x :1 adSupportedChannel; unsigned int x :1 isDigitalReplicaAd; unsigned int x :1 isNativeAd; unsigned int x :1 isUserSubscribedToFeed; unsigned int x :1 isVideoInFeed; } _has;
}
