...
@interface NTPBShareInformationScreenView : PBCodable<NSCopying> {
  /* instance variables */
  struct { unsigned int x :1 paidSubscriptionConversionPointType; unsigned int x :1 parentFeedType; unsigned int x :1 resultType; unsigned int x :1 userAction; unsigned int x :1 arrivedFromAd; unsigned int x :1 subscriptionOnlyArticlePreview; } _has;
}
