...
//
#ifndef NTKPodcastsComplicationDataSource_h
#define NTKPodcastsComplicationDataSource_h
@import Foundation;
...
@interface NTKPodcastsComplicationDataSource : NTKComplicationDataSource<NTKMediaComplicationControllerDelegate> {
  /* instance variables */
...
#endif /* NTKPodcastsComplicationDataSource_h */
