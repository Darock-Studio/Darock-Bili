...
//
#ifndef NTKRadioComplicationDataSource_h
#define NTKRadioComplicationDataSource_h
@import Foundation;
...
@interface NTKRadioComplicationDataSource : NTKComplicationDataSource<NTKMediaComplicationControllerDelegate> {
  /* instance variables */
...
#endif /* NTKRadioComplicationDataSource_h */
