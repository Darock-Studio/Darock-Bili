...
//
#ifndef NTKComplicationPushClientDelegate_Protocol_h
#define NTKComplicationPushClientDelegate_Protocol_h
@import Foundation;
...
#endif /* NTKComplicationPushClientDelegate_Protocol_h */
