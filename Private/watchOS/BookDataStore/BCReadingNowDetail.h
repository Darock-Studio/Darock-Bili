...
@property (@dynamic, nonatomic) BOOL isTrackedAsRecent;
@property (copy, @dynamic, nonatomic) NSDate *lastEngagedDate;
@property (copy, @dynamic, nonatomic) NSString *cloudAssetType;
