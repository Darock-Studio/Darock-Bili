...
+ (id)eventWithTipID:(id)id animationFinished:(BOOL)finished animationSource:(id)source collectionID:(id)id correlationID:(id)id;

/* instance methods */
- (id)initWithCoder:(id)coder;
- (id)_initWithTipID:(id)id animationFinished:(BOOL)finished animationSource:(id)source collectionID:(id)id correlationID:(id)id;
