...
@interface PREAMResponseItem : PBCodable<NSCopying> {
  /* instance variables */
  struct { unsigned int x :1 ageGroup; unsigned int x :1 modelId; unsigned int x :1 position; unsigned int x :1 replyTextId; unsigned int x :1 responseClassId; unsigned int x :1 isApricotDevice; unsigned int x :1 isCustomResponse; unsigned int x :1 isRobotResponse; } _has;
}
