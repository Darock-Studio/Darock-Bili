...
//
#ifndef NPKAutoTopUpAmountSetupSectionProvider_h
#define NPKAutoTopUpAmountSetupSectionProvider_h
@import Foundation;
...
@interface NPKAutoTopUpAmountSetupSectionProvider : NPKPassDetailSectionProvider

@property (retain, nonatomic) PKPaymentPassAction *action;
@property (retain, nonatomic) NSDecimalNumber *selectedAmount;
...
#endif /* NPKAutoTopUpAmountSetupSectionProvider_h */
