...
+ (long long)_heatingCoolingValueForTargetHeaterCoolerState:(long long)state isActive:(BOOL)active;
+ (id)targetHeatingCoolingModeValueInResponse:(id)response;
+ (id)targetTemperatureValueInResponse:(id)response;
+ (long long)_heatingCoolingValueForCurrentHeaterCoolerState:(long long)state isActive:(BOOL)active;
