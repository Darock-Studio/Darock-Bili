...
//
#ifndef BMSiriMemoryReferenceResolution_h
#define BMSiriMemoryReferenceResolution_h
@import Foundation;
...
/* instance methods */
- (id)initWithVersion:(id)version entityMapElements:(id)elements;
...
#endif /* BMSiriMemoryReferenceResolution_h */
