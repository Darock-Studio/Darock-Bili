...
/* instance methods */
- (id)initWithAggregationStartTimestamp:(id)timestamp numberOfDaysAggregation:(id)aggregation aggregationStats:(id)stats cohortType:(id)type intendedRequestRatio:(id)ratio;
