...
//
#ifndef PLSyndicationDeleteManagerDelegate_Protocol_h
#define PLSyndicationDeleteManagerDelegate_Protocol_h
@import Foundation;
...
#endif /* PLSyndicationDeleteManagerDelegate_Protocol_h */
