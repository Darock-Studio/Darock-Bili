...
//
#ifndef CKNanoHashtagImagesReplyViewController_h
#define CKNanoHashtagImagesReplyViewController_h
@import Foundation;

#include "STSNanoBrowser.h"
...
@interface CKNanoHashtagImagesReplyViewController : STSNanoBrowser<CKNanoReplyViewControllerProtocol>
...
- (id)initForNewMessageCompose:(id)compose;
- (void)viewWillAppear:(BOOL)appear;
- (void)viewDidAppear:(BOOL)appear;
@end

#endif /* CKNanoHashtagImagesReplyViewController_h */
