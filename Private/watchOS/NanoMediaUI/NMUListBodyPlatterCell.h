...
//
#ifndef NMUListBodyPlatterCell_h
#define NMUListBodyPlatterCell_h
@import Foundation;
...
@interface NMUListBodyPlatterCell : PUICListBodyPlatterCell {
  /* instance variables */
  NSLayoutConstraint *_consistentHeightConstraint;
}
...
#endif /* NMUListBodyPlatterCell_h */
